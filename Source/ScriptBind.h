...
BIND_ASSERT( engine->RegisterObjectMethod( "Critter", "void RunClientScript(const string&in funcName, int p0, int p1, int p2, const string@+ p3, int[]@+ p4)", asFUNCTION( BIND_CLASS Cl_RunClientScript ), asCALL_CDECL_OBJFIRST ) );
...
BIND_ASSERT( engine->RegisterObjectMethod( "Map", "void PlaySound(const string&in soundName) const", asFUNCTION( BIND_CLASS Map_PlaySound ), asCALL_CDECL_OBJFIRST ) );
BIND_ASSERT( engine->RegisterObjectMethod( "Map", "void PlaySound(const string&in soundName, uint16 hexX, uint16 hexY, uint radius) const", asFUNCTION( BIND_CLASS Map_PlaySoundRadius ), asCALL_CDECL_OBJFIRST ) );
...
BIND_ASSERT( engine->RegisterGlobalFunction( "void Message(const string&in text)", asFUNCTION( BIND_CLASS Global_Message ), asCALL_CDECL ) );
BIND_ASSERT( engine->RegisterGlobalFunction( "void Message(const string&in text, int type)", asFUNCTION( BIND_CLASS Global_MessageType ), asCALL_CDECL ) );
...
BIND_ASSERT( engine->RegisterGlobalFunction( "uint GetAllMapObjects(ItemCl@[]@+ items)", asFUNCTION( BIND_CLASS Global_GetAllMapObjects ), asCALL_CDECL ) );
...
BIND_ASSERT( engine->RegisterGlobalProperty( "LookData HotLookData_0", &ScriptLookData0 ) );
BIND_ASSERT( engine->RegisterGlobalProperty( "LookData HotLookData_1", &ScriptLookData1 ) );
...
BIND_ASSERT( engine->RegisterGlobalProperty( "LookData ItemLookData", &ItemLookData ) );
BIND_ASSERT( engine->RegisterGlobalProperty( "LookData ItemLightLookData", &ItemLightLookData ) );
